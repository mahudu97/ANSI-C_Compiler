...
mips-linux-gnu-gcc -ansi -S test_cases/IF_ELSE_F.c -o asm/IF_ELSE_F.s
...
mips-linux-gnu-gcc -ansi -S test_cases/FOR_N.c -o asm/FOR_N.s
mips-linux-gnu-gcc -ansi -static -o bin/FOR_N asm/FOR_N.s test_cases/FOR_N_driver.c
qemu-mips bin/FOR_N
echo $? >> test_results.txt

echo LOCAL_ARRAY >> test_results.txt
mips-linux-gnu-gcc -ansi -S test_cases/LOCAL_ARRAY.c -o asm/LOCAL_ARRAY.s
...
mips-linux-gnu-gcc -ansi -S test_cases/SELF_RECURSION.c -o asm/SELF_RECURSION.s
...
mips-linux-gnu-gcc -ansi -S test_cases/GLOBAL.c -o asm/GLOBAL.s
...
mips-linux-gnu-gcc -ansi -S test_cases/MAIN.c -o asm/MAIN.s
mips-linux-gnu-gcc -ansi -static -o bin/MAIN asm/MAIN.s test_cases/MAIN_driver.c
qemu-mips bin/MAIN
echo $? >> test_results.txt

echo ATOF >> test_results.txt
mips-linux-gnu-gcc -ansi -S test_cases/ATOF.c -o asm/ATOF.s
